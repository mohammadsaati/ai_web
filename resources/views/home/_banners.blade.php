...
<section class="pt-4 pb-0 card-grid">
    <div class="container">
        <div class="row g-4">
            ...
            <!-- Left big card -->
            <div class="col-lg-6">
                <div class="card card-overlay-bottom card-grid-lg card-bg-scale" style="background-image:url({{ imagePath('banners/'.$data['banners'][0]->image) }}); background-position: center left; background-size: cover;">
                    <!-- Card featured -->
                ...
                <div class="row g-4">
                    ...
                    @foreach($data['banners'] as $banner)
                        <div class="col-md-6">
                            ...
                            <div class="card card-overlay-bottom card-grid-sm card-bg-scale" style="background-image:url({{ imagePath('banners/'.$banner->image) }}); background-position: center left; background-size: cover;">
                                <!-- Card Image overlay -->
                                <div class="card-img-overlay d-flex align-items-center p-3 p-sm-4">
                                    <div class="w-100 mt-auto">
                                        <!-- Card category -->
